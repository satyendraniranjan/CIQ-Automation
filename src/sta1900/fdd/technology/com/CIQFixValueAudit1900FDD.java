...
public class CIQFixValueAudit1900FDD {
	...
	/* VLAN_Check.....................................................................................*/			
				...
				{}  // System.out.println("inside 20");                                 }
					...
					new CiqColorsheet1900FDD1().ciqColorsheet1(file, "bandwidth", fileName);
	...
	/*			
	 ENODEB_Name..............................................................................*/			
				...
				{
						new CiqColorsheet1900FDD1().ciqColorsheet1(file,"EnodeB",fileName);
				}
...
/*	 FIX Value..............................................................................*/		
				...
				else new CiqColorsheet1900FDD1().ciqColorsheet1(file,"mcc",fileName);
				...
				new CiqColorsheet1900FDD1().ciqColorsheet1(file,"mnc",fileName);
					
				
				if(row.getCell(1)==null || df.formatCellValue(row.getCell(1)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"market",fileName);
				
				if(row.getCell(2)==null || df.formatCellValue(row.getCell(2)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"market_id",fileName);
				
				
				if(row.getCell(3)==null || df.formatCellValue(row.getCell(3)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"LSR",fileName);
				
				if(row.getCell(4)==null || df.formatCellValue(row.getCell(4)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"LSM",fileName);
				
				if(row.getCell(5)==null || df.formatCellValue(row.getCell(5)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"LSM_IP",fileName);
				
				if(row.getCell(9)==null || df.formatCellValue(row.getCell(9)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Cabinet",fileName);
			...
			/*	if(row.getCell(11)==null || df.formatCellValue(row.getCell(11)).equals(""))
				...
				*/
				...
				if(row.getCell(13)==null || df.formatCellValue(row.getCell(13)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Latitude_Ns",fileName);
				
				if(row.getCell(15)==null || df.formatCellValue(row.getCell(15)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Latitude_Ws",fileName);
				
				
				if(row.getCell(16)==null || df.formatCellValue(row.getCell(16)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Trackcode",fileName);
				
				if(row.getCell(17)==null || df.formatCellValue(row.getCell(17)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Tac_Hex",fileName);
				...
				if(row.getCell(20)==null || df.formatCellValue(row.getCell(20)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"sss",fileName);
				
				if(row.getCell(21)==null || df.formatCellValue(row.getCell(21)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"pss",fileName);
				
				if(row.getCell(23)==null || df.formatCellValue(row.getCell(23)).equals(""))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"plmn",fileName);
				
				if(row.getCell(24)==null || df.formatCellValue(row.getCell(24)).equals("") || !df.formatCellValue(row.getCell(24)).equals("25"))
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"band",fileName);
				...
				if(row.getCell(27)==null || df.formatCellValue(row.getCell(27)).equals(""))
				    new CiqColorsheet1900FDD1().ciqColorsheet1(file,"UEarfcn",fileName);
					
				
				if(row.getCell(28)==null || df.formatCellValue(row.getCell(28)).equals(""))
				    new CiqColorsheet1900FDD1().ciqColorsheet1(file,"rru",fileName);
				
				
				if(row.getCell(29)==null || df.formatCellValue(row.getCell(29)).equals(""))
				{
					//System.out.println("inside career");
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"Career",fileName);
				}
				
				if(row.getCell(32)==null || df.formatCellValue(row.getCell(32)).equals(""))
				{
					//System.out.println("Inside Frame");
					new CiqColorsheet1900FDD1().ciqColorsheet1(file,"ecgi",fileName);
				}
  ...
  /*  PhyCell_ID.........................................................................*/
    ...
    if(count1==phycell.size())
    {
    	...
    	new CiqColorsheet1900FDD1().ciqColorsheet1(file,"phycell",fileName);
  ...
  /*  RSI...................................................................................*/
    ...
    if(count1==rsi.size() && rsiflag==0){}
    	...
    	new CiqColorsheet1900FDD1().ciqColorsheet1(file,"rsi",fileName);
    }
   ...
   /* Calling Second task.............................................................................*/ 
    ...
    String eNB_Id = null;     
     ...
     new Ipbh1900().ipbh(file,cascade,fileName,eNB_Id,lst,count1);
