...
public class ScheduleNameSiteCode1900FDD {
...
new ReadDump41900FDD().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);

}
else
{
	new CiqColorsheet1900FDD1().ciqColorsheet1(file1,"channel",fileName);
	...
	new CiqColorsheet1900FDD1().ciqColorsheet1(file1,"diversity",fileName);
