...
import sta.twentyfive.cdu30.technology.com.ReadCIQOtherValuesCDU30;

public class Earfcn2500CDU30 {
...
/* Start Getting Values From EARFCN........................................*/
		   ...
		   LOGGER.log(Level.SEVERE, "2.5 TDD CDU30/ScheduleNameSiteCodeCDU30/ReadDump4CDU30/Earfcn2500CDU30", "Ciq Channel= "+hm);
		  // new ScheduleNameSiteCode().scheduleNameSiteCode(hm,hmValues,antenna_name,file1,cascade,fileName,band);
		  new ReadCIQOtherValuesCDU30().readCIQValue(hm,hmValues,antenna_name,file1,cascade,fileName,sitecode);
