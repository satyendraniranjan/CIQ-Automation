...
public class AuditEcsfbCombine800FDD {
	...
	public void readCIQ(File file,String s, String PN_OFF, String fileName, String eNB_id, List<String> lst, int sectorno)
	{
		 try {
	           ...
	           // List<String> ciq_pn_off = new ArrayList<>();
	            ...
	            HashSet<String> ciq_pn_off1= new HashSet<String>();
	            ...
	            for(int i=1; i<sheet.getLastRowNum()+1;i++)
	            {
	            	...
	            	if(df.formatCellValue(row.getCell(0)).isEmpty()) {
	            	 ...
	            	 if(!df.formatCellValue(row.getCell(0)).equals(eNB_id)) {
	            		 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"eNB_id",fileName);
	            		 break;
	 	            }	
...
/* Start Comparing Fix Values............................................................................*/	  
	                ...
	                if(df.formatCellValue(row.getCell(2)).equals(s1[3]) && df.formatCellValue(row.getCell(2)).length()==5)
	                {
	                  // System.out.print("OTA_sid Equal");
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"OTA_SID",fileName);
	                ...
	                if(df.formatCellValue(row.getCell(11)).equals(s1[0])) {
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"BTS_Id",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(9)).equals(s1[1])) {
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"BSC_SId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(10)).equals(s1[2])) {
	                	...
	                	//System.out.print("\tBSC_NId Equal");
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"BSC_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(3)).equals(s1[4])) {
	                	...
	                	//System.out.print("\tOTA_NId Equal");
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"OTA_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(4)).equals(s1[6])) {
	                	...
	                	//System.out.print("\tReg_Zone Equal");
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"REG_Z",fileName);
	                 
	                 if(df.formatCellValue(row.getCell(7)).equals(LtmOff)){
		                	//System.out.print("\tLTM_OFF Equal");
	                 }
	                 else
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"LTM_OFF",fileName);
...
/* Start Storing PN_OFF......................................................................*/	                 
					 ...
					 if(sectorno>0)
					 {
						 ...
						 ciq_pn_off1.add(df.formatCellValue(row.getCell(14)));
	                ...
	                // System.out.println(MNC_ID.equals(df.formatCellValue(row.getCell(6))));
				     ...
				     if(MNC_ID.equals(df.formatCellValue(row.getCell(6)))) {
	                	// System.out.print("\tMNC_ID Equal");
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"MNC_ID",fileName);
	                 ...
	                 if(MCC_ID.equals(df.formatCellValue(row.getCell(5)))){
	                	 ...
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"MCC_ID",fileName);
	                 
	                 if(BandClass.equals(df.formatCellValue(row.getCell(12))) || BandClass1.equals(df.formatCellValue(row.getCell(12)))){
	                	//System.out.print("\tBandClass Equal");
	                 }
	                 else
	                	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"BandClass",fileName); 
...
/* Start Comparing PN_OFF Values....................................................................*/	         
	          ...
	          // System.out.println(count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
	            ...
	            HashSet<String> pn_off = new HashSet<String>();
	            pn_off.add(PN_OFF);
	            for(int i=0;i<count2;i++)
	            {
	            	System.out.println(ciq_pn_off1+" "+PN_OFF);
	            	if(ciq_pn_off1.equals(pn_off)) {
				    	 //System.out.print("\tPN_OFF Equal");
				    	 }
				     else
				    	 new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"PN_OFF",fileName);
	            }
...
/* Start Comparing Cell_Num.......................................................................*/
	          ...
	          /*  if(lst.equals(cell_Num))
	            {}
	              ...
	              new CiqColorsheetCombine800FDD2().ciqColorsheet2(file,"cell_Num",fileName);*/
