...
public class ReadCIQOtherValuesCombine800FDD {
...
/* Start Reading Azimuth, Antenna, Latitude and Longitude and Diversity..................*/
						...
						if(count==0)
						{
                        alpha1= df.formatCellValue(row.getCell(12))+" "+df.formatCellValue(row.getCell(14))+" "+df.formatCellValue(row.getCell(32));
						//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                        new CompareOtherValues800FDD().compareOtherValues(file,alpha,alpha1,fileName);
						}
                        if(count==1)
                        {
                        beta1= df.formatCellValue(row.getCell(12))+" "+df.formatCellValue(row.getCell(14))+" "+df.formatCellValue(row.getCell(32));	
                        //ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                        new CompareOtherValues800FDD().compareOtherValues(file,beta,beta1,fileName);
                        }
                        if(count==2)
                        {
                    	gamma1= df.formatCellValue(row.getCell(12))+" "+df.formatCellValue(row.getCell(14))+" "+df.formatCellValue(row.getCell(32));
                    	//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                    	new CompareOtherValues800FDD().compareOtherValues(file,gamma,gamma1,fileName);
                        }
						...
						ciqchannel.add(df.formatCellValue(row.getCell(25)));
						
						if(!sitecode.equals(df.formatCellValue(row.getCell(7))))
						{
							//new CiqColorsheet800FDD1().ciqColorsheet1(file,"sitecode",fileName);
						}
...
/*  Start Comparing Channel....................................................*/		    
		   ...
		   // System.out.println(ciqchannel.isEmpty()+" "+!ciqchannel.isEmpty());
		    ...
		    if((ciqchannel.first().equals(dumpchannel1.last()) && ciqchannel.size()==1) || (dumpchannel1.size()==1 && ciqchannel.equals(dumpchannel1))) {}
		    	...
		    	new CiqColorsheetCombine800FDD1().ciqColorsheet1(file,"channel",fileName);
		    	}
		    	else
		    	new CiqColorsheetCombine800FDD1().ciqColorsheet1(file,"channel",fileName);
		    }
...
/* Start comparing Antenna Model........................................................................*/
		    ...
		    LOGGER.log(Level.SEVERE, "Combine800FDD/ScheduleNameSiteCodeCombine800FDD/ReadDump4Combine800FDD/ReadCIQOtherValueCombine800FDD", "antenna_name= "+antenna_name);
		
		    new CompareArfcnCombine800FDD().compareArfcn800FDD(file,dumpchannel1.first(),fileName);
