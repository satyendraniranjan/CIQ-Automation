...
public class ReadECSFBDUMP1900CDU30 {
	...
	public void readCIQ(File file1,Object object, String fileName, String eNB_id, List<String> lst)
	{
		 try {
	           ...
	           // System.out.println("Hi");
					...
					for (int k = 0; k <= 0; k++) {
						...
						if (!str.equals(object) && flag == 0) {
							...
							//System.out.println(PN_OFF);
							 LOGGER.log(Level.SEVERE, "1900 FDDCDU30/CIQFixValueAudit1900CDU30/ReadECSFBDUMP1900CDU30", PN_OFF);
							new AuditEcsfb1900CDU30().readCIQ(file1,s,PN_OFF,fileName,eNB_id,lst);
						}
	            ...
	            if(flag1==0)
	            {
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"PN_OFF",fileName);
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"BandClass",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"MCC_ID",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"MNC_ID",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"LTM_OFF",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"REG_Z",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"OTA_NID",fileName); 
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"BSC_SId",fileName);
	            	new CiqColorsheet1900CDU302().ciqColorsheet2(file1,"OTA_SID",fileName);
	            }
