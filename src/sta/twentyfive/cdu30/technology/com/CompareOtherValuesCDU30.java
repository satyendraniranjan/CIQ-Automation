...
public class CompareOtherValuesCDU30 {
	...
	public void compareOtherValues(File file, String[] dump, String ciq, String fileName)
	{
	    ...
	    for(int i=0;i<ciq1.length;i++)
	    {
	    	...
	    	/*else
	    		new CiqColorsheetCDU301().ciqColorsheet1(file,"latitude",fileName);*/
	    	}
	    	...
	    	/*else
	    		new CiqColorsheetCDU301().ciqColorsheet1(file,"longitude",fileName);*/
	    	}
