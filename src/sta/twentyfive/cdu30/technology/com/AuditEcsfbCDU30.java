...
import sta.eighthundred.fdd.technology.com.CiqColorsheet800FDD2;

public class AuditEcsfbCDU30 {
	private static final Logger LOGGER = Logger.getLogger(Ciqframe.class.getName());
	public void readCIQ(File file,String s, String PN_OFF, String fileName, String eNB_id, List<String> lst, int sectorno, HashSet<String> diversity)
	{
		 try {
	           ...
	           // List<String> ciq_pn_off = new ArrayList<>();
	            ...
	            HashSet<String> enodebinfo= new HashSet<>();
/* Start Reading.............................................................................*/	            
	          ...
	          // System.out.println(sheet.getLastRowNum()); 
	            for(int i=1; i<sheet.getLastRowNum()+1;i++)
	            {
	            	...
	            	///System.out.println(df.formatCellValue(row.getCell(0)).isEmpty()); 
...
/* Start Comparing eNB_id ............................................................................*/	         
	     ...
	     // System.out.println(df.formatCellValue(row.getCell(1))); 
	      ...
	      enodebinfo.add(df.formatCellValue(row.getCell(0)));  
...
/* Start Comparing Fix Values............................................................................*/	  
	                ...
	                if(df.formatCellValue(row.getCell(2)).equals(s1[3]))
	                {
	                  // System.out.print("OTA_sid Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"OTA_SID",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(9)).equals(s1[0])) {
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"BTS_Id",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(7)).equals(s1[1])) {
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"BSC_SId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(8)).equals(s1[2])) {
	                	...
	                	//System.out.print("\tBSC_NId Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"BSC_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(3)).equals(s1[4])) {
	                	...
	                	//System.out.print("\tOTA_NId Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"OTA_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(11)).equals(s1[5])) {
	                	...
	                	//System.out.print("\tFA_Id Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"FA_Id",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(4)).equals(s1[6])) {
	                	...
	                	//System.out.print("\tReg_Zone Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"REG_Z",fileName);
	                 
	                 if(df.formatCellValue(row.getCell(5)).equals(LtmOff)){
		                	//System.out.print("\tLTM_OFF Equal");
	                 }
	                 else
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"LTM_OFF",fileName);
...
/* Start Storing PN_OFF......................................................................*/	                 
	                ...
	                cell_id= df.formatCellValue(row.getCell(1));
					 ...
					 else if(diversity.contains("8T8R"))
					 {
...
/* Start Comparing Fix Values..............................................................*/
	                 ...
	                 if(BandClass.equals(df.formatCellValue(row.getCell(10)))){
	                	//System.out.print("\tBandClass Equal");
	                	 ...
	                	 new CiqColorsheetCDU302().ciqColorsheet2(file,"BandClass",fileName); 
...
/* EnodeB........................................................................................*/
	          ...
	          //  System.out.println(enodebinfo.contains(eNB_id));
	            
	   /*if(!enodebinfo.contains(eNB_id))         
	   {
	           ...
	           System.out.println(count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
	            for(int i=0;i<count2;i++)
	            {
	            	...
	            	if(ciq_pn_off.get(i).equals(s2[i]) && pnoff_size.size()==count2 && ciq_pn_off.size()<=s2.length) {
				    	 ...
				    	 new CiqColorsheetCDU302().ciqColorsheet2(file,"PN_OFF",fileName);
	            }
        
	            
	           // System.out.print("outside of pnoff"+ciq_pn_off);
...
/* Start Comparing Cell_Num.......................................................................*/
	          ...
	          System.out.println(lst+" "+cell_Num);
	            ...
	            {}
	              ...
	              new CiqColorsheetCDU302().ciqColorsheet2(file,"cell_Num",fileName);
	            
	            LOGGER.log(Level.SEVERE, "2.5 TDD CDU30/CIQFixValueAuditCDU30/ReadECSFBDUMPCDU30/AuditEcsfbCDU30", count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
