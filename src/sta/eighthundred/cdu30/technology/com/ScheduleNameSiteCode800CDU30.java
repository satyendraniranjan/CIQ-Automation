...
public class ScheduleNameSiteCode800CDU30 {
...
LOGGER.log(Level.SEVERE, "800 FDDCDU30/ScheduleNameSiteCode800CDU30", schedule+" "+sitecode);
new ReadDump800CDU304().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);
}
else
{
	new CiqColorsheet800CDU301().ciqColorsheet1(file1,"channel",fileName);
	new CiqColorsheet800CDU301().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet800CDU301().ciqColorsheet1(file1,"sitecode",fileName);
	new CiqColorsheet800CDU301().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheet800CDU301().ciqColorsheet1(file1,"diversity",fileName);
