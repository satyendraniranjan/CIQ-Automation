...
public class ScheduleNameSiteCode800FDD {
...
LOGGER.log(Level.SEVERE, "800 FDD/ScheduleNameSiteCode800FDD", "ScheduleName= "+schedule+"AppianSitecodeName= "+sitecode);
new ReadDump4800FDD().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);

}
else
{
	new CiqColorsheet800FDD1().ciqColorsheet1(file1,"channel",fileName);
	...
	new CiqColorsheet800FDD1().ciqColorsheet1(file1,"diversity",fileName);
