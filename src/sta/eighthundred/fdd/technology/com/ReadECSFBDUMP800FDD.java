...
public class ReadECSFBDUMP800FDD {
	...
	public void readCIQ(File file1,Object object, String fileName, String eNB_id, List<String> lst, int sectorno)
	{
		 try {
	           FileInputStream file = new FileInputStream(new File("C:\\\\CIQ Audit\\\\Inventory\\\\ECSFB_PARAM_DUMP.xlsx"));
					...
					for (int k = 0; k <= 0; k++) {
						...
						if (!str.equals(object) && flag == 0) {
							...
							//System.out.println(PN_OFF);
							 LOGGER.log(Level.SEVERE, "800 FDD/CIQFixValueAudit800FDD/ReadECSFBDUMP800FDD","PN_OFF Values= "+PN_OFF);
							new AuditEcsfb800FDD().readCIQ(file1,s,PN_OFF,fileName,eNB_id,lst,sectorno);
						}
	            ...
	            if(flag1==0)
	            {
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"PN_OFF",fileName);
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"BandClass",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"MCC_ID",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"MNC_ID",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"LTM_OFF",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"REG_Z",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"OTA_NID",fileName); 
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"BSC_SId",fileName);
	            	new CiqColorsheet800FDD2().ciqColorsheet2(file1,"OTA_SID",fileName);
	            }
