...
public class ReadCIQOtherValues800FDD {
...
/*  Start Comparing Channel....................................................*/		    
		   ...
		   // System.out.println(ciqchannel.isEmpty()+" "+!ciqchannel.isEmpty());
		    ...
		    if((ciqchannel.first().equals(dumpchannel1.last()) && ciqchannel.size()==1) || (dumpchannel1.size()==1 && ciqchannel.equals(dumpchannel1))) {}
		    	...
		    	new CiqColorsheet800FDD1().ciqColorsheet1(file,"channel",fileName);
		    	}
		    	else
		    	new CiqColorsheet800FDD1().ciqColorsheet1(file,"channel",fileName);
		    }
...
/* Start comparing Antenna Model........................................................................*/
		    ...
		    LOGGER.log(Level.SEVERE, "800 FDD/ScheduleNameSiteCode800FDD/ReadDump4800FDD/Earfcn800FDD/ReadCIQOtherValue800FDD", "antenna_name= "+antenna_name);
		
		    new CompareArfcn800FDD().compareArfcn800FDD(file,dumpchannel1.first(),fileName);
