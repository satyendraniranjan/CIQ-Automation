...
public class AuditEcsfb1900CDMA {
...
/* Start Comparing Fix Values............................................................................*/	  
	                ...
	                if(df.formatCellValue(row.getCell(1)).equals(s1[0])) {
	                	 ...
	                	 new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"BTS_ID",fileName);
	                 
	                 
	                 if(df.formatCellValue(row.getCell(13)).equals(s1[4])) {
	                ...
	                // System.out.println("bye");
	                 ...
	                 if(df.formatCellValue(row.getCell(46)).equals(s1[6])) {
	                	...
	                	//System.out.print("\tReg_Zone Equal");
	                	 ...
	                	 new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"REG_Z",fileName);
	                 
	                 if(df.formatCellValue(row.getCell(45)).equals(LtmOff)){
		                	//System.out.print("\tLTM_OFF Equal");
	                 }
	                 else
	                	 new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"LTM_OFF",fileName);
	                
/* Start Storing PN_OFF......................................................................*/	                 
	                 
	                 
	                 pnoff_size.add(df.formatCellValue(row.getCell(11)));
				   ...
				   /*  if(count==count1 && count1<3)
				   {
				    	 ...
				    	 ciq_pn_off.put(count2, df.formatCellValue(row.getCell(11)));
				    			 count2++;
				    			 count1++;
				     ...
				     if(count==0)
					   {
					    	 //System.out.println("inside the loop");
					    	 //ciq_pn_off[count1]= df.formatCellValue(row.getCell(14));
					    	 ciq_pn_off.put(count,df.formatCellValue(row.getCell(20)));
					    			 count2++;
					    			 }
					     if(count==1)
					     {
...
/* Start Comparing PN_OFF Values....................................................................*/	         
	           ...
	           System.out.println(count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
	            for(int i=0;i<count2;i++)
	            {
	            	...
	            	if(ciq_pn_off.get(i).equals(s2[i])) {
	            ...
	            LOGGER.log(Level.SEVERE, "1900 CDMA/CIQFixValueAudit1900CDMA/staconnectivity1900CDMA/ReadECSFBDUMP1900CDMA/AuditEcsfb1900CDMA", count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
