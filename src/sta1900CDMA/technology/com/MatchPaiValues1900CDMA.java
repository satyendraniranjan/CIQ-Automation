...
public class MatchPaiValues1900CDMA {
		  ...
		  //  HashSet<String> diversity= new HashSet<>();
		    ...
		    for (int j = 1; j < sheet.getLastRowNum() + 1; j++) {
				...
				for (int k = 2; k <= 2; k++) {
					...
					String s = "";
					//System.out.println(str+" "+ciqmscpair);
...
/*
		    ...
		    LOGGER.log(Level.SEVERE, "1900 CDMA/CIQFixValueAudit1900CDMA/MatchPaiValues1900CDMA","Pai Values of Dump = "+mscpair+"Pai Values of CIQ= "+paiValues);
			if(!mscpair.equals(paiValues) || flag==0)
			{    
				//System.out.print("inside");
				new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"fortytwo",fileName);
				new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"fortythree",fileName);
				new CiqColorsheet1900CDMA301().ciqColorsheet1(file,"fortyfour",fileName);
			}
