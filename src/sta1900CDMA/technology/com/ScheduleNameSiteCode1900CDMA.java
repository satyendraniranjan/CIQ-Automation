...
public class ScheduleNameSiteCode1900CDMA {
...
LOGGER.log(Level.SEVERE, "1900 CDMA/ScheduleNameSiteCode1900CDMA", schedule+" "+sitecode);
new ReadDump41900CDMA().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);
}
else
{
	new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"channel",fileName);
	new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"sitecode",fileName);
	new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"diversity",fileName);
	//new CiqColorsheet1900CDMA301().ciqColorsheet1(file1,"longitude",fileName);
}
