...
public class MatchSwitchMscPair {
	...
	public void matchSwithcMscPair(File file, Object cascade, String fileName, String bsmname, HashSet<String> ciqmscpair)
	{
		try
		{
		  ...
		  //  HashSet<String> diversity= new HashSet<>();
		    ...
		    LOGGER.log(Level.SEVERE, "800 CDMA/CIQFixValueAudit800CDMA/MatchSwitchMscPair800CDMA",ciqmscpair+" MSC Pair should be= "+mscpair);
			if(!mscpair.equals(ciqmscpair))
			{
				new CiqColorsheet800CDMA301().ciqColorsheet1(file,"third",fileName);
