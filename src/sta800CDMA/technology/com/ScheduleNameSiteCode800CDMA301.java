...
public class ScheduleNameSiteCode800CDMA301 {
...
LOGGER.log(Level.SEVERE, "800 CDMA/ScheduleNameSiteCode800CDMA", schedule+" "+sitecode);
new ReadDump4800CDMA().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);
}
else
{
	new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"channel",fileName);
	new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"sitecode",fileName);
	new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"diversity",fileName);
	//new CiqColorsheet800CDMA301().ciqColorsheet1(file1,"longitude",fileName);
}
