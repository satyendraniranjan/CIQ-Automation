...
public class ReadCIQOtherValuesCombine1900CDU30 {
...
/* Start Reading Azimuth, Antenna, Latitude and Longitude and Diversity..................*/
                        ...
                        new CompareOtherValuesCombine1900CDU30().compareOtherValues(file,alpha,alpha1,fileName);
						}
                        if(count==1)
                        {
                        ...
                        //ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                        new CompareOtherValuesCombine1900CDU30().compareOtherValues(file,beta,beta1,fileName);
                        }
                        if(count==2)
                        {
                    	...
                    	//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                    	new CompareOtherValuesCombine1900CDU30().compareOtherValues(file,gamma,gamma1,fileName);
                        }
...
/* Start comparing Antenna Model........................................................................*/
		    ...
		    LOGGER.log(Level.SEVERE, "Combine1900 FDDCDU30/ScheduleNameSiteCodeCombine1900CDU30/ReadDumpCombine1900CDU30/ReadCIQOtherValueCombine1900CDU30", antenna_name+" "+ciq_antenna_name);
		    ...
		    new CompareArfcnCombine1900CDU30().compareArfcn800FDD(file,channel,fileName);
