...
public class CompareOtherValuesCombine800CDU30 {
	...
	public void compareOtherValues(File file, String[] dump, String ciq, String fileName)
	{
	    ...
	    for(int i=0;i<ciq1.length;i++)
	    {
	    	...
	    	/*else
	    		new CiqColorsheet800CDU301().ciqColorsheet1(file,"latitude",fileName);*/
	    	}
	    	...
	    	/*else
	    		new CiqColorsheet800CDU301().ciqColorsheet1(file,"longitude",fileName);*/
	    	}
	    ...
	    LOGGER.info("Combine 00FDD CDU30/ScheduleNameSiteCodeCDU30/ReadDump4CDU30/Earfcn2500CDU30/ReadCIQOtherValueCDU30/CompareOtherValuesCDU30");
