...
public class ReadCIQOtherValuesCombineCDU30 {
...
/* Start Reading Azimuth, Antenna, Latitude and Longitude and Diversity..................*/
                       ...
                       // new CompareOtherValuesCombineCDU30().compareOtherValues(file,alpha,alpha1,fileName);
						}
                        if(count==1)
                        {
                        ...
                        //ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                      //  new CompareOtherValuesCombineCDU30().compareOtherValues(file,beta,beta1,fileName);
                        }
                        if(count==2)
                        {
                    	...
                    	//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                    	//new CompareOtherValuesCombineCDU30().compareOtherValues(file,gamma,gamma1,fileName);
                        }
...
/*  Start Comparing Channel....................................................*/		    
		   ...
		   dumpchannel1.add(str1[i]);
		    ...
		    if(ciqchannel.first().equals(dumpchannel1.last()) && ciqchannel.size()==1) {}
		    else
