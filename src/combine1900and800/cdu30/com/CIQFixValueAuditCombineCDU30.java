...
public class CIQFixValueAuditCombineCDU30 {
	...
	/* VLAN_Check.....................................................................................*/			
			   ...
			   // System.out.println("hi");
				if(df.formatCellValue(row.getCell(44)).equals("34") && df.formatCellValue(row.getCell(47)).equals("42")){
					...
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"VLAN", fileName);
	...
	/* ENODEB_Name..............................................................................*/			
				...
				{
						new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"EnodeB",fileName);
				}
...
/*	 FIX Value..............................................................................*/		
				...
				if(row.getCell(4)==null || df.formatCellValue(row.getCell(4)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"LSR",fileName);
				
				if(row.getCell(5)==null || df.formatCellValue(row.getCell(5)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"LSM",fileName);
				
				if(row.getCell(7)==null || df.formatCellValue(row.getCell(7)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"LSM_IP",fileName);
				
				if(row.getCell(10)==null || df.formatCellValue(row.getCell(10)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Cabinet",fileName);
			...
			/*	if(row.getCell(11)==null || df.formatCellValue(row.getCell(11)).equals(""))
				...
				*/
				...
				//System.out.println(df.formatCellValue(row.getCell(12)).equals("")+" "+row.getCell(12).equals(null)+" "+df.formatCellValue(row.getCell(12)).contains("")+" "+df.formatCellValue(row.getCell(12)).contains(null));
				if(row.getCell(12)==null || df.formatCellValue(row.getCell(12)).equals("")) {
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Latitude_Ns",fileName);
				//System.out.println("Hi");
					
				}
				
				if(row.getCell(14)==null || df.formatCellValue(row.getCell(14)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Latitude_Ws",fileName);
				
				
				if(row.getCell(15)==null || df.formatCellValue(row.getCell(15)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Trackcode",fileName);
				
				if(row.getCell(16)==null || df.formatCellValue(row.getCell(16)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Tac_Hex",fileName);
				
				if(row.getCell(17)==null || df.formatCellValue(row.getCell(17)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"RRH",fileName);
				
				if(row.getCell(18)==null || df.formatCellValue(row.getCell(18)).equals(""))
				{
					//System.out.println("Inside RRHModel");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"RRHModel",fileName);
				}
				
				
				if(row.getCell(19)==null || df.formatCellValue(row.getCell(19)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"RRH_Top",fileName);
				
				if(row.getCell(23)==null || df.formatCellValue(row.getCell(23)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Eutran",fileName);
				
				
				if(row.getCell(27)==null || df.formatCellValue(row.getCell(27)).equals(""))
				    new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"SEarfcn",fileName);
				
				
				if(row.getCell(29)==null || df.formatCellValue(row.getCell(29)).equals(""))
				    new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"UEarfcn",fileName);
				
				
				if(row.getCell(31)==null || df.formatCellValue(row.getCell(31)).equals(""))
				    new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Initiate",fileName);
				
				
				if(row.getCell(32)==null || df.formatCellValue(row.getCell(32)).equals(""))
				{
					//System.out.println("inside career");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Career",fileName);
				}
				
				if(row.getCell(33)==null || df.formatCellValue(row.getCell(33)).equals(""))
				{
					//System.out.println("Inside Frame");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Frame",fileName);
				}
				
				
				if(row.getCell(35)==null || df.formatCellValue(row.getCell(35)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Avendor",fileName);
				
				

				if(row.getCell(37)==null || df.formatCellValue(row.getCell(37)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Electrical",fileName);
				
				if(row.getCell(38)==null || df.formatCellValue(row.getCell(38)).equals(""))
				{
					//System.out.println("Inside Mechanical");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Mechanical",fileName);
				}
				...
				if(row.getCell(39)==null || df.formatCellValue(row.getCell(39)).equals(""))
				{
					...
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Network_Mask",fileName);
				}
				
				
				if(row.getCell(40)==null || df.formatCellValue(row.getCell(40)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"CSR_Hostname",fileName);
							
							
				if(row.getCell(41)==null || df.formatCellValue(row.getCell(41)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"CSR_Type",fileName);
				
				if(row.getCell(42)==null || df.formatCellValue(row.getCell(42)).equals(""))
				{
					//System.out.println("Inside Csr_Port");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"CSR_Port",fileName);
				
				}
				
				
				if(row.getCell(43)==null || df.formatCellValue(row.getCell(43)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"Fiber_SFP",fileName);
				
				
				if(row.getCell(45)==null || df.formatCellValue(row.getCell(45)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"CSR_OAM_IP",fileName);
				
				if(row.getCell(46)==null || df.formatCellValue(row.getCell(46)).equals(""))
				{
					//System.out.println("eNB_OAM");
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"eNB_OAM",fileName);
				}
				
				
				if(row.getCell(48)==null  || df.formatCellValue(row.getCell(48)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"CSR_S_B",fileName);
				
				if(row.getCell(49)==null  || df.formatCellValue(row.getCell(49)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"eNB_S_B",fileName);
				
				
				
				if(row.getCell(50)==null  || df.formatCellValue(row.getCell(50)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R1",fileName);
				
				if(row.getCell(51)==null || df.formatCellValue(row.getCell(51)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R2",fileName);
				
				if(row.getCell(52)==null || df.formatCellValue(row.getCell(52)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R3",fileName);
				
				if(row.getCell(53)==null || df.formatCellValue(row.getCell(53)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R4",fileName);
				
				if(row.getCell(54)==null || df.formatCellValue(row.getCell(54)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R5",fileName);
				
				if(row.getCell(55)==null || df.formatCellValue(row.getCell(55)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R6",fileName);
				
				if(row.getCell(56)==null || df.formatCellValue(row.getCell(56)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R7",fileName);
				
				if(row.getCell(57)==null  || df.formatCellValue(row.getCell(57)).equals(""))
					new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"IP_R8",fileName);
				
/* Checking Bandwidth .............................................................................*/	
				//System.out.println(df.formatCellValue(row.getCell(20)).equals("1900"));
				if(df.formatCellValue(row.getCell(20)).equals("1900"))
				{
				//System.out.println(df.formatCellValue(row.getCell(26)).equals("10")+" "+df.formatCellValue(row.getCell(20)).equals("5"));
				if(df.formatCellValue(row.getCell(26)).equals("10") || df.formatCellValue(row.getCell(26)).equals("5"))
			     { // System.out.println("inside 1900 match");                                 
				}
			
			    else
				new CiqColorsheetCombineCDU301().ciqColorsheet1(file, "bandwidth", fileName);
			
				}
				
				if(df.formatCellValue(row.getCell(20)).equals("800"))
				{
					//System.out.println(df.formatCellValue(row.getCell(26)).equals("5")+" "+df.formatCellValue(row.getCell(26)).equals("3"));
					if(df.formatCellValue(row.getCell(26)).equals("5") || df.formatCellValue(row.getCell(26)).equals("3"))
				{   //System.out.println("inside 800 match");                                 
					}
  ...
  /*  PhyCell_ID.........................................................................*/
    ...
    if(count1==phycell.size())
    {
    	...
    	new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"phycell",fileName);
  ...
  /*  RSI...................................................................................*/
    ...
    if(count1==rsi.size() && rsiflag==0){}
    	...
    	new CiqColorsheetCombineCDU301().ciqColorsheet1(file,"rsi",fileName);
    }
    ...
    {}
    	...
    	new CiqColorsheetCombineCDU301().ciqColorsheet1(file, "azimuth", fileName);
    
    
    //System.out.println("eNB size="+eNB_id.size());
    if(eNB_id.size()==1) {}
    else
    	new CiqColorsheetCombineCDU301().ciqColorsheet1(file, "eNB_id", fileName);
 ...
 */
   ...
   /* Calling Second task.............................................................................*/ 
    ...
    String eNB_Id = null;     
     ...
     LOGGER.log(Level.SEVERE, "Combine FDDCDU30/CIQFixValueAuditCombineCDU30", lst);
   new ReadECSFBDUMPCombineCDU30().readCIQ(file,cascade,fileName,eNB_Id,lst);      
