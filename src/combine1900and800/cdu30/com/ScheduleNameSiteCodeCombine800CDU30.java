...
public class ScheduleNameSiteCodeCombine800CDU30 {
...
LOGGER.log(Level.SEVERE, "Combine800 FDDCDU30/ScheduleNameSiteCodeCombine800CDU30", schedule+" "+sitecode);
new ReadDumpCombine800CDU304().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);
}
else
{
	new CiqColorsheetCombineCDU301().ciqColorsheet1(file1,"channel",fileName);
	new CiqColorsheetCombineCDU301().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet800CDU301().ciqColorsheet1(file1,"sitecode",fileName);
	new CiqColorsheetCombineCDU301().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheetCombineCDU301().ciqColorsheet1(file1,"diversity",fileName);
	//new CiqColorsheet800CDU301().ciqColorsheet1(file1,"longitude",fileName);
}
