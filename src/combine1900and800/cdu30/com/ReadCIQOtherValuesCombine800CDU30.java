...
public class ReadCIQOtherValuesCombine800CDU30 {
...
/* Start Reading Azimuth, Antenna, Latitude and Longitude and Diversity..................*/
                        ...
                        new CompareOtherValuesCombine800CDU30().compareOtherValues(file,alpha,alpha1,fileName);
						}
                        if(count==1)
                        {
                        ...
                        //ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                        new CompareOtherValuesCombine800CDU30().compareOtherValues(file,beta,beta1,fileName);
                        }
                        if(count==2)
                        {
                    	...
                    	//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                    	new CompareOtherValuesCombine800CDU30().compareOtherValues(file,gamma,gamma1,fileName);
                        }
...
/* Start comparing Antenna Model........................................................................*/
		    ...
		    new CompareArfcnCombine800FDDCDU30().compareArfcn800FDD(file, dumpchannel1.first(), fileName);
		    
		    LOGGER.log(Level.SEVERE, "Combine 800FDD CDU30/CIQFixValueAuditCombine800FDD/ReadECSFBDUMPCombine800FDD/ReadCIQOtherValueCombine800FDDCDU30", antenna_name+" "+ciq_antenna_name); 
