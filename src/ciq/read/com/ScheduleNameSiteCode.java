...
public class ScheduleNameSiteCode {
...
LOGGER.log(Level.SEVERE, "2.5 TDD CDU20/ScheduleNameSiteCode", schedule);
new ReadDump4().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);
}
else
{
	new CiqColorsheet1().ciqColorsheet1(file1,"channel",fileName);
	new CiqColorsheet1().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet1().ciqColorsheet1(file1,"sitecode",fileName);
	new CiqColorsheet1().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheet1().ciqColorsheet1(file1,"diversity",fileName);
	//new CiqColorsheet1().ciqColorsheet1(file1,"longitude",fileName);
}
