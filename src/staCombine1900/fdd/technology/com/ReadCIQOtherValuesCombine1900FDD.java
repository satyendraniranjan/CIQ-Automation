...
public class ReadCIQOtherValuesCombine1900FDD {
...
/* Start Reading Azimuth, Antenna, Latitude and Longitude and Diversity..................*/
                        ...
                        new CompareOtherValuesCombine1900FDD().compareOtherValues(file,alpha,alpha1,fileName);
						}
                        if(count==1)
                        {
                        beta1= df.formatCellValue(row.getCell(12))+" "+df.formatCellValue(row.getCell(14))+" "+df.formatCellValue(row.getCell(33));	
                        //ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                        new CompareOtherValuesCombine1900FDD().compareOtherValues(file,beta,beta1,fileName);
                        }
                        if(count==2)
                        {
                    	gamma1= df.formatCellValue(row.getCell(12))+" "+df.formatCellValue(row.getCell(14))+" "+df.formatCellValue(row.getCell(33));
                    	//ciqchannel.put(count, df.formatCellValue(row.getCell(21)));
                    	new CompareOtherValuesCombine1900FDD().compareOtherValues(file,gamma,gamma1,fileName);
                        }
						...
						System.out.println(df.formatCellValue(row.getCell(26)));
...
/*  Start Comparing Channel............................................................*/		    
		    System.out.println("ciqchannel= "+ciqchannel);
		    int counter=0;
...
/* Start comparing Antenna Model........................................................................*/
		    ...
		    new CompareArfcnCombine1900FDD().compareArfcn800FDD(file,channel,fileName);
