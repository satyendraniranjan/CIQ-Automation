...
public class AuditEcsfbCombine1900FDD {
	            ...
	            for(int i=1; i<sheet.getLastRowNum()+1;i++)
	            {
	            	...
	            	if(df.formatCellValue(row.getCell(0)).isEmpty()) {
	            	 ...
	            	 if(!df.formatCellValue(row.getCell(0)).equals(eNB_id)) {
	            		 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"eNB_id",fileName);
	            		 break;
	 	            }	
...
/* Start Comparing Fix Values............................................................................*/	  
	                ...
	                if(df.formatCellValue(row.getCell(2)).equals(s1[3]))
	                {
	                  // System.out.print("OTA_sid Equal");
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"OTA_SID",fileName);
	                ...
	                if(df.formatCellValue(row.getCell(11)).equals(s1[0])) {
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"BTS_Id",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(9)).equals(s1[1])) {
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"BSC_SId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(10)).equals(s1[2])) {
	                	...
	                	//System.out.print("\tBSC_NId Equal");
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"BSC_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(3)).equals(s1[4])) {
	                	...
	                	//System.out.print("\tOTA_NId Equal");
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"OTA_NId",fileName);
	                 ...
	                 if(df.formatCellValue(row.getCell(4)).equals(s1[6])) {
	                	...
	                	//System.out.print("\tReg_Zone Equal");
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"REG_Z",fileName);
	                 
	                 if(df.formatCellValue(row.getCell(7)).equals(LtmOff)){
		                	//System.out.print("\tLTM_OFF Equal");
	                 }
	                 else
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"LTM_OFF",fileName);
	                ...
	                // System.out.println(MNC_ID.equals(df.formatCellValue(row.getCell(6))));
				     ...
				     if(MNC_ID.equals(df.formatCellValue(row.getCell(6)))) {
	                	// System.out.print("\tMNC_ID Equal");
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"MNC_ID",fileName);
	                 ...
	                 if(MCC_ID.equals(df.formatCellValue(row.getCell(5)))){
	                	 ...
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"MCC_ID",fileName);
	                 
	                 if(BandClass.equals(df.formatCellValue(row.getCell(12)))){
	                	//System.out.print("\tBandClass Equal");
	                 }
	                 else
	                	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"BandClass",fileName); 
	           ...
	           System.out.println(count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
	            for(int i=0;i<count2;i++)
	            {
	            	...
	            	if(ciq_pn_off.get(i).equals(s2[i]) && pnoff_size.size()==count2 && ciq_pn_off.size()<=s2.length) {
				    	 ...
				    	 new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"PN_OFF",fileName);
	            }
...
/* Start Comparing Cell_Num.......................................................................*/
	           ...
	           System.out.println(lst+" "+cell_Num);
	            ...
	            {}
	              ...
	              new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file,"cell_Num",fileName);
	            
	            LOGGER.log(Level.SEVERE, "1900 FDD/CIQFixValueAudit1900FDD/Ipbh1900/ReadECSFBDUMP1900FDD/AuditEcsfb1900FDD", count2+" "+pnoff_size.size()+" "+ciq_pn_off.size()+" "+s2.length);
