...
public class ScheduleNameSiteCodeCombine1900FDD {
...
//System.out.println("inside schedule Name");
...
LOGGER.log(Level.SEVERE, "1900 FDD/ScheduleNameSiteCode1900FDD", "ScheduleName= "+schedule+"AppianSitecodeName= "+sitecode);
new ReadDump4Combine1900FDD().readDump4( file1, cascade, fileName, band,schedule1, sitecode1);

}
else
{
	new CiqColorsheet1Combine1900FDD().ciqColorsheet1(file1,"channel",fileName);
	//new CiqColorsheet800FDD1().ciqColorsheet1(file1,"antenna_name",fileName);
	//new CiqColorsheet1900FDD1().ciqColorsheet1(file1,"sitecode",fileName);
	//new CiqColorsheet800FDD1().ciqColorsheet1(file1,"azimuth",fileName);
	new CiqColorsheet1Combine1900FDD().ciqColorsheet1(file1,"diversity",fileName);
	//new CiqColorsheet1900FDD1().ciqColorsheet1(file1,"longitude",fileName);
}
