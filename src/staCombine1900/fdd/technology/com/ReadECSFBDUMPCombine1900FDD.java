...
public class ReadECSFBDUMPCombine1900FDD {
	...
	public void readCIQ(File file1,Object object, String fileName, String eNB_id, List<String> lst, int sectorno)
	{
	            ...
	            for (int j = 1; j < sheet.getLastRowNum() + 1; j++) 
	            {
					...
					for (int k = 0; k <= 0; k++) {
                      ...
                      // System.out.println(!str.equals(object));
							...
							new AuditEcsfbCombine1900FDD().readCIQ(file1,s,PN_OFF,fileName,eNB_id,lst,sectorno);
						}
		 ...
		 if(flag1==0)
		 {
	            	...
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"PN_OFF",fileName);
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"BandClass",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"MCC_ID",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"MNC_ID",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"LTM_OFF",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"REG_Z",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"OTA_NID",fileName); 
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"BSC_SId",fileName);
	            	new CiqColorsheet2Combine1900FDD().ciqColorsheet2(file1,"OTA_SID",fileName);
