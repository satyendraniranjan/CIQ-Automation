		...
		try {
			...
			for(int i=1;i<2;i++)
			{
				...
				if(row.getCell(0)==null || df.formatCellValue(row.getCell(0)).equals("") || !df.formatCellValue(row.getCell(0)).equals(cascade))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"zero",fileName);
				
				if(row.getCell(1)==null || df.formatCellValue(row.getCell(1)).equals("") || !df.formatCellValue(row.getCell(1)).equals(eNB_Id))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"one",fileName);
				
				if(row.getCell(2)==null || df.formatCellValue(row.getCell(2)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"two",fileName);
				
				
				if(row.getCell(3)==null || df.formatCellValue(row.getCell(3)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"three",fileName);
				
				if(row.getCell(4)==null || df.formatCellValue(row.getCell(4)).equals(""))
				{
					//System.out.println("four");
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"four",fileName);
				}
				
				//System.out.println(df.formatCellValue(row.getCell(5)));
				if(row.getCell(5)==null || df.formatCellValue(row.getCell(5)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"five",fileName);
				
				
				if(row.getCell(6)==null || df.formatCellValue(row.getCell(6)).equals("") || !df.formatCellValue(row.getCell(6)).equals("32"))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"six",fileName);
				
				
				if(row.getCell(7)==null || df.formatCellValue(row.getCell(7)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"seven",fileName);
				
				if(row.getCell(8)==null || df.formatCellValue(row.getCell(8)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"eight",fileName);
				
				
				if(row.getCell(9)==null || df.formatCellValue(row.getCell(9)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"nine",fileName);
				
				if(row.getCell(10)==null || df.formatCellValue(row.getCell(10)).equals("") || !df.formatCellValue(row.getCell(10)).equals("40"))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"ten",fileName);
				
				
				if(row.getCell(11)==null || df.formatCellValue(row.getCell(11)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"eleven",fileName);
				
				if(row.getCell(12)==null || df.formatCellValue(row.getCell(12)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twelve",fileName);
				
				if(row.getCell(13)==null || df.formatCellValue(row.getCell(13)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"thirteen",fileName);
				
				if(row.getCell(14)==null || df.formatCellValue(row.getCell(14)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"forteen",fileName);
				
				if(row.getCell(15)==null || df.formatCellValue(row.getCell(15)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"fifteen",fileName);
				
				if(row.getCell(16)==null || df.formatCellValue(row.getCell(16)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"sixteen",fileName);
				
				if(row.getCell(17)==null || df.formatCellValue(row.getCell(17)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"seventeen",fileName);
				
				if(row.getCell(18)==null || df.formatCellValue(row.getCell(18)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"eightteen",fileName);
				
				if(row.getCell(19)==null || df.formatCellValue(row.getCell(19)).equals(""))
						new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"nineteen",fileName);
				
				if(row.getCell(20)==null || df.formatCellValue(row.getCell(20)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twenty",fileName);
				
				if(row.getCell(21)==null || df.formatCellValue(row.getCell(21)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twentyone",fileName);
				
				if(row.getCell(22)==null || df.formatCellValue(row.getCell(22)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twentytwo",fileName);
				
				if(row.getCell(23)==null || df.formatCellValue(row.getCell(23)).equals("") )
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twentythree",fileName);
				
				if(row.getCell(24)==null || df.formatCellValue(row.getCell(24)).equals(""))
					new CiqColorsheet3Combine1900FDD().ciqColorsheet1(file,"twentyfour",fileName);
					
			}
			LOGGER.log(Level.SEVERE, "1900 FDD/CIQFixValueAudit1900FDD/Ipbh1900");
			//System.out.println("hi");
			//new ReadECSFBDUMPCombine1900FDD().readCIQ(file,cascade,fileName,eNB_Id,lst,sectorno);
